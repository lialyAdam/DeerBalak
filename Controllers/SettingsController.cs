...
namespace Deerbalak.Controllers
{
    ...
    public class SettingsController : BaseController
    {
        ...
        public async Task<IActionResult> UpdateProfilePicture(UpdateProfilePictureVM profilePictureVM)
        {
            ...
            (profilePictureVM.ProfilePictureImage, Deerbalak.Data.Helpers.Enums.ImageFileType.ProfilePicture);

            await _usersService.UpdateUserProfilePicture(loggedInUserId.Value,
